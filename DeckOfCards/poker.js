...
function drawCard(deckObj, cardIndex) {
  ...
  ourReq.addEventListener("load", function(){
    ...
    console.log(deckData.remaining);
    if(deckData.remaining < 5) {
      shuffleDeck(deckObj.deck_id);
    }
...
//functions which accepts three callback functions and an object holding a card array, returns best hand found
